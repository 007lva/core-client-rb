Feature: Environment Variables
  ...
  Background:
    ...
    And I have the following environment variables:
      | Name          | Value               | Application Name  | Environment Name  |
      | SECRET_BASE   | abc=                | blog_app          | staging           |
      | DB_PASSWORD   | 123qweasd!!         | blog_app          | staging           |
      | SECRET_BASE   | qwe=                | blog_app          | production        |
      | DB_PASSWORD   | 987qweasd!!         | blog_app          | production        |
      | DB_PASSWORD   | my_secure_password  | todo_app          | staging           |
